...
resource "google_compute_backend_service" "backend_service" {
  ...
  backend {
    group                 = google_compute_region_instance_group_manager.web_private_group.instance_group
    balancing_mode        = "RATE"
...
resource "google_compute_region_autoscaler" "autoscaler" {
  ...
  target = google_compute_region_instance_group_manager.web_private_group.self_link
